			...
			<div class="mt-20 mb-10">
				...
				<div class='flex my-12'>
					<div class="w-1/2 pr-10">	
						<p>ID</p>
						<input type="text" name='id' value="{{$news -> id}}" readonly disabled  class="border p-1 w-full bg-gray-200">
					</div>
					<div class="w-1/2 pr-10">	
						<p>Upload_at</p>
						<input type="text" name='uploat_at' value="{{$news -> upload_at}}" disabled readonly class="border p-1 w-full bg-gray-200">
					</div>
				</div>
				...
				<div class='flex'>
					<div class="w-1/2 pr-10">	
						<p>Title</p>
						<input type="text" name='title' value="{{$news -> title}}" placeholder="title" class="border p-1 w-full">
					</div>
					<div class="w-1/2 pr-10">	
						<p>Image</p>
				...
				<div class="flex mt-10">
					...
					<div class="hidden" id="img_preview">
						<p>Preview</p>
						<img src="{{$news -> image}}" alt="" class="h-32 mt-5" id="showImg">
					</div>
				</div>
